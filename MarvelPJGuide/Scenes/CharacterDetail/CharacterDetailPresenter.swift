...
class CharacterDetailPresenter: CharacterDetailPresenterLogic, CharacterDetailDataStore {
    ...
    func configViews() {
        ...
        if let description = characterModel.description,
           !description.isEmpty {
            descriptionViewModel = CDDescriptionViewModel(titleText: "character_detail_description".localized, descriptionText: description)
        } else {
        ...
        if let comics = characterModel.comics?.items {
            ...
            comicsViewModel = CDMultipleItemsViewModel(titleText: "character_detail_comics".localized, items: comicsString)
        } else {
            comicsViewModel = nil
        }
        ...
        if let series = characterModel.series?.items {
            ...
            seriesViewModel = CDMultipleItemsViewModel(titleText: "character_detail_series".localized, items: seriesString)
        } else {
            seriesViewModel = nil
        }
        ...
        if let events = characterModel.events?.items {
            ...
            eventsViewModel = CDMultipleItemsViewModel(titleText: "character_detail_events".localized, items: eventsString)
        } else {
            eventsViewModel = nil
        }
        ...
        if let stories = characterModel.stories?.items {
            ...
            storiesViewModel = CDMultipleItemsViewModel(titleText: "character_detail_stories".localized, items: storiesString)
        } else {
